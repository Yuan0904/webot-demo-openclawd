...
show_usage() {
    cat << EOF
clawlog - WebBot Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View WebBot logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    WebBot logs flow through the macOS unified log (subsystem: ai.webbot).
