...
function resolveAnthropicDefaultAuthMode(cfg: WebBotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: WebBotConfig): WebBotConfig {
...
export function applyTalkApiKey(config: WebBotConfig): WebBotConfig {
...
export function applyModelDefaults(cfg: WebBotConfig): WebBotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: WebBotConfig): WebBotConfig {
...
export function applyLoggingDefaults(cfg: WebBotConfig): WebBotConfig {
...
export function applyContextPruningDefaults(cfg: WebBotConfig): WebBotConfig {
...
export function applyCompactionDefaults(cfg: WebBotConfig): WebBotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
