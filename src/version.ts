...
declare const __WEBBOT_VERSION__: string | undefined;
const CORE_PACKAGE_NAME = "webbot";
...
// Single source of truth for the current WebBot version.
// - Embedded/bundled builds: injected define or env var.
// - Dev/npm builds: package.json.
export const VERSION =
  (typeof __WEBBOT_VERSION__ === "string" && __WEBBOT_VERSION__) ||
  process.env.WEBBOT_BUNDLED_VERSION ||
