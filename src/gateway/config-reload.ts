...
import type { WebBotConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: WebBotConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: WebBotConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: WebBotConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: WebBotConfig) => void;
  log: {
