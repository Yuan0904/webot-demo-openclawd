...
const OfficeVersionCreateParamsBaseSchema = Type.Object(
  {
    filePath: NonEmptyString,
    versionType: Type.Optional(
      Type.Union([Type.Literal("before_ai"), Type.Literal("after_ai")]),
    ),
    taskId: Type.Optional(Type.String()),
    createdBy: Type.Optional(Type.Union([Type.Literal("ai"), Type.Literal("system")])),
  },
  { additionalProperties: false },
);

const OfficeVersionListParamsBaseSchema = Type.Object(
  {
    filePath: NonEmptyString,
...
const OfficeVersionRestoreParamsBaseSchema = Type.Object(
  {
    filePath: NonEmptyString,
    versionId: NonEmptyString,
    markCurrent: Type.Optional(Type.Boolean()),
  },
  { additionalProperties: false },
);

export const SkillsXlsxVersionCreateParamsSchema = OfficeVersionCreateParamsBaseSchema;
export const SkillsXlsxVersionListParamsSchema = OfficeVersionListParamsBaseSchema;
export const SkillsXlsxVersionRestoreParamsSchema = OfficeVersionRestoreParamsBaseSchema;

export const SkillsOfficeVersionCreateParamsSchema = OfficeVersionCreateParamsBaseSchema;
export const SkillsOfficeVersionListParamsSchema = OfficeVersionListParamsBaseSchema;
export const SkillsOfficeVersionRestoreParamsSchema = OfficeVersionRestoreParamsBaseSchema;
