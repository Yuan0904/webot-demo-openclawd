...
function authorizeGatewayMethod(method: string, client: GatewayRequestOptions["client"]) {
  ...
  if (
    ...
    method === "skills.office.version.create" ||
    method === "skills.office.version.list" ||
    method === "skills.office.version.restore" ||
    method === "skills.xlsx.version.create" ||
    method === "skills.xlsx.version.list" ||
    method === "skills.xlsx.version.restore" ||
    method === "cron.add" ||
    method === "cron.update" ||
    method === "cron.remove" ||
    method === "cron.run" ||
