...
function listConfiguredAgentIds(cfg: WebBotConfig): string[] {
...
export function listAgentsForGateway(cfg: WebBotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: WebBotConfig): string {
...
function resolveSessionStoreAgentId(cfg: WebBotConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: WebBotConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: WebBotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: WebBotConfig): GatewaySessionsDefaults {
