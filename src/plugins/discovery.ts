...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @webbot/voice-call -> voice-call).
...
export function discoverWebBotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".webbot", "extensions")];
