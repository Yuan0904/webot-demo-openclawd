...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/webbot/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/webbot/extensions",
        global: "/Users/x/.webbot/extensions",
        workspace: "/Users/x/ws/.webbot/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.webbot/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/webbot/extensions",
        global: "/Users/x/.webbot/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.webbot/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/webbot/extensions",
        global: "/Users/x/.webbot/extensions",
