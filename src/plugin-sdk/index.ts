...
export type { WebBotConfig } from "../config/config.js";
/** @deprecated Use WebBotConfig instead */
export type { WebBotConfig as ClawdbotConfig } from "../config/config.js";
