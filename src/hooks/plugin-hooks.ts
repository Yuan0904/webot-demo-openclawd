...
import type { WebBotPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: WebBotPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: WebBotPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
