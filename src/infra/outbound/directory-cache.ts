...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: WebBotConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: WebBotConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: WebBotConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: WebBotConfig): void {
