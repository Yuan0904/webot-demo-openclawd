...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "webbot-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveWebBotPackageRoot } = await import("./webbot-root.js");
    ...
    vi.mocked(resolveWebBotPackageRoot).mockResolvedValue("/opt/webbot");
