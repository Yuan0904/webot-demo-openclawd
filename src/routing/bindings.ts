...
export function listBindings(cfg: WebBotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: WebBotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: WebBotConfig) {
