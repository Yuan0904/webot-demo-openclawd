...
function resolveMentionPatterns(cfg: WebBotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: WebBotConfig | undefined, agentId?: string): RegExp[] {
