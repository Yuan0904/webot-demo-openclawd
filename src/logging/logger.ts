...
export const DEFAULT_LOG_DIR = "/tmp/webbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "webbot.log"); // legacy single-file path

const LOG_PREFIX = "webbot";
...
function resolveSettings(): ResolvedSettings {
  let cfg: WebBotConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => WebBotConfig;
      };
