...
function resolveAvatarSource(cfg: WebBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: WebBotConfig, agentId: string): AgentAvatarResolution {
