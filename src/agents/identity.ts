import type { WebBotConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: WebBotConfig, agentId: string): string {
...
export function resolveIdentityName(cfg: WebBotConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[webbot]";
}
