...
// pi-ai's built-in Anthropic catalog can lag behind WebBot's defaults/docs.
...
export function buildModelAliasLines(cfg?: WebBotConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveWebBotAgentDir();
