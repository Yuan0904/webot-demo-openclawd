...
describe("createWebBotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createWebBotCodingTools({
      config,
    ...
    const anthropicTools = createWebBotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createWebBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createWebBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
