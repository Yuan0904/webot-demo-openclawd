...
export const DEFAULT_SANDBOX_IMAGE = "webbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "webbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "webbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "webbot-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "webbot-sbx-browser-";
