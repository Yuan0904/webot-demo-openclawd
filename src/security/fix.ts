...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof WebBotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: WebBotConfig; env: NodeJS.ProcessEnv }): {
  cfg: WebBotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
...
export async function fixSecurityFootguns(opts?: {
  ...
  if (snap.valid) {
    ...
    const whatsappStoreAllowFrom: string[] = [];
