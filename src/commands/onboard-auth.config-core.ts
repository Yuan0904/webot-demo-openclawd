...
export function applyZaiConfig(cfg: WebBotConfig): WebBotConfig {
...
export function applyOpenrouterProviderConfig(cfg: WebBotConfig): WebBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: WebBotConfig): WebBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: WebBotConfig): WebBotConfig {
...
export function applyOpenrouterConfig(cfg: WebBotConfig): WebBotConfig {
...
export function applyLitellmProviderConfig(cfg: WebBotConfig): WebBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyLitellmConfig(cfg: WebBotConfig): WebBotConfig {
...
export function applyMoonshotProviderConfig(cfg: WebBotConfig): WebBotConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: WebBotConfig): WebBotConfig {
...
export function applyMoonshotConfig(cfg: WebBotConfig): WebBotConfig {
...
export function applyMoonshotConfigCn(cfg: WebBotConfig): WebBotConfig {
...
export function applyKimiCodeProviderConfig(cfg: WebBotConfig): WebBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: WebBotConfig): WebBotConfig {
...
export function applySyntheticProviderConfig(cfg: WebBotConfig): WebBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: WebBotConfig): WebBotConfig {
...
export function applyXiaomiProviderConfig(cfg: WebBotConfig): WebBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: WebBotConfig): WebBotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: WebBotConfig): WebBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: WebBotConfig): WebBotConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: WebBotConfig): WebBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: WebBotConfig): WebBotConfig {
...
export function applyXaiProviderConfig(cfg: WebBotConfig): WebBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: WebBotConfig): WebBotConfig {
...
export function applyQianfanProviderConfig(cfg: WebBotConfig): WebBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: WebBotConfig): WebBotConfig {
