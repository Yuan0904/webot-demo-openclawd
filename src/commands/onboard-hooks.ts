...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.webbot.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("webbot hooks list")}`,
      `  ${formatCliCommand("webbot hooks enable <name>")}`,
      `  ${formatCliCommand("webbot hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
