...
const ensureWebBotModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveWebBotAgentDir = vi.fn().mockReturnValue("/tmp/webbot-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/webbot-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureWebBotModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveWebBotAgentDir,
}));
