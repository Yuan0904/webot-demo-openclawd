...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "webbot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<WebBotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<WebBotConfig["telegram"]>>,
