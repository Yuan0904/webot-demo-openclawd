...
function resolveDefaultAccountId(cfg: WebBotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: WebBotConfig): boolean {
...
export function summarizeBindings(cfg: WebBotConfig, bindings: AgentBinding[]): string[] {
