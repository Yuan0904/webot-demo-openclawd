...
function resolveConfiguredModelRaw(cfg: WebBotConfig): string {
...
function resolveConfiguredModelKeys(cfg: WebBotConfig): string[] {
...
export function applyPrimaryModel(cfg: WebBotConfig, model: string): WebBotConfig {
...
export function applyModelAllowlist(cfg: WebBotConfig, models: string[]): WebBotConfig {
  const defaults = cfg.agents?.defaults;
