          ...
          [
            {
              ...
              "extract": true,
              "stripComponents": 1,
              "targetDir": "~/.webbot/tools/sherpa-onnx-tts/runtime",
            ...
            },
            {
              ...
              "archive": "tar.bz2",
              "extract": true,
              "targetDir": "~/.webbot/tools/sherpa-onnx-tts/models",
...
1. Download the runtime for your OS (extracts into `~/.webbot/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.webbot/tools/sherpa-onnx-tts/models`)

Update `~/.webbot/webbot.json`:
...
```json5
{
  skills: {
    entries: {
      "sherpa-onnx-tts": {
        env: {
          SHERPA_ONNX_RUNTIME_DIR: "~/.webbot/tools/sherpa-onnx-tts/runtime",
          SHERPA_ONNX_MODEL_DIR: "~/.webbot/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high",
        },
      },
    },
  },
